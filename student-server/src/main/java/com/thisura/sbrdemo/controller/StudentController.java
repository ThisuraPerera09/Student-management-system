...
import com.thisura.sbrdemo.service.IStudentService;
...
public class StudentController {
    ...
    @PostMapping
    public Student addStudent(@RequestBody Student student, @RequestParam Long departmentId){
...
//    }
    ...
    @PutMapping("/update/{id}")
    public Student updateStudent(@RequestBody Student student, @PathVariable Long id, @RequestParam List<Long> courseIds) {
        return studentService.updateStudentWithCourses(student, id, courseIds);
    }
